...
def generate_wxs(config: Config, tree: DirNode) -> str:
    ...
    # .exe is still installed — it just gets no Start Menu presence). The shortcut
    # shows the launcher's title when one is set, else its exe name.
