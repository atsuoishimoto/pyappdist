...
- [`pyvisionmarker`](https://github.com/atsuoishimoto/pyappdist/tree/main/samples/pyvisionmarker) — Gradio + pywebview object detection; environment markers pick the backend, MSI license dialog
